...
<head>
    ...
    <title>Smart Parking - Pricing Configuration</title>
...
<body class="bg-background-light  text-slate-900  font-display">
    <div class="flex min-h-screen">
        ...
        <aside class="w-72 bg-white  border-r border-slate-200  flex flex-col fixed h-full">
            <div class="p-6 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-slate-500 text-xs font-medium uppercase tracking-wider">Admin System</p>
                </div>
            </div>
            <nav class="flex-1 px-4 py-4 space-y-1">
                ...
                <a class="flex items-center gap-3 px-3 py-2.5 text-slate-600  hover:bg-slate-50  rounded-lg transition-colors group"
                    ...
                    <span class="text-sm font-semibold">Violations</span>
                </a>
                <a class="flex items-center gap-3 px-3 py-2.5 text-slate-600  hover:bg-slate-50  rounded-lg transition-colors group"
                    href="7_Reports.html">
            ...
            <div class="p-4 mt-auto border-t border-slate-200 ">
                <div class="flex items-center gap-3 p-2">
                    <div class="w-10 h-10 rounded-full bg-slate-200" data-alt="User profile avatar circle"
                        style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuDQT3HPztD4x17_dGG3WalQtjZom6jCe4BMP_x4XOAitaX3aYow5zuBVFlraPQKKHs2Fj4kNfuBfhjZIFHR1YdlmfTR2TFfWPtHcQcc47Vhyv_XLymA6L0UWahGKOY6XluudL_hkpwA1kl8ioTWtUKXQPYEJW3gsPMMwpmtnIlJEtE6oVmQkOSyfOPAmZlq7itlTiz71peChZ_3WkfnlUnnreL6Hy66mvu9TpEYod2mlikn_nJXkjc4EEWTtOUADycjsAPMnUM6hxc");'>
                    </div>
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-bold truncate">Alex Thompson</p>
        ...
        <main class="flex-1 ml-72 flex flex-col">
            <!-- Header -->
            <header
                class="h-20 bg-white  border-b border-slate-200  px-8 flex items-center justify-between sticky top-0 z-10">
                <div>
                    <h2 class="text-2xl font-extrabold text-slate-900  tracking-tight">Parking Pricing
                        Rules</h2>
                    <p class="text-sm text-slate-500">Configure hourly pricing and peak hour rates for different parking
                        locations.</p>
                </div>
                <div class="flex items-center gap-4">
                    ...
                    <span class="text-sm font-medium text-slate-600 ">Last updated: 2 mins ago</span>
                </div>
            </header>
            <!-- Page Content -->
                ...
                <div class="bg-white  rounded-xl shadow-sm border border-slate-200  overflow-hidden mb-8">
                    ...
                    <form method="POST" class="p-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">Peak
                                    Hour Pricing ($)</label>
                                <div class="relative">
                                    <span
                        ...
                        <div
                            class="flex items-center justify-between p-4 bg-accent/5 rounded-lg border border-accent/10 mb-8">
                            <div class="flex items-center gap-3">
                                <span class="material-symbols-outlined text-accent">info</span>
                                <p class="text-sm text-accent font-medium">Peak hour pricing applies during high demand
                                    periods (8:00 AM - 10:00 AM &amp; 5:00 PM - 7:00 PM).</p>
                            </div>
                        </div>
