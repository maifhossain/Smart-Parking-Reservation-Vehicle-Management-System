...
<body class="bg-background-light  font-display text-slate-900  antialiased">
    <div class="flex min-h-screen">
        <!-- Sidebar Navigation -->
        <aside
            class="w-72 bg-white  border-r border-slate-200  flex flex-col fixed h-full z-20">
            <div class="p-6 flex items-center gap-3">
                <div class="w-10 h-10 bg-primary rounded-lg flex items-center justify-center text-white">
                    <span class="material-symbols-outlined">local_parking</span>
                </div>
                <div>
                    <h1 class="text-lg font-bold leading-none text-primary">Smart Parking</h1>
                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Admin Management</p>
                </div>
            </div>
            <nav class="flex-1 px-4 py-4 space-y-1">
                ...
                <a class="flex items-center gap-3 px-4 py-3 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg transition-colors"
                    ...
                    <span class="font-medium text-sm">Parking Managers</span>
                </a>
                <a class="flex items-center gap-3 px-4 py-3 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg transition-colors"
                    href="#">
                    <span class="material-symbols-outlined">map</span>
                    <span class="font-medium text-sm">Parking Locations</span>
                </a>
                <a class="flex items-center gap-3 px-4 py-3 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg transition-colors"
                    href="#">
            ...
            <div class="p-4 border-t border-slate-200 dark:border-slate-800">
                <div class="flex items-center gap-3 p-2 bg-slate-50 dark:bg-slate-800 rounded-xl">
                    <div
                        class="w-10 h-10 rounded-full bg-primary/20 flex items-center justify-center text-primary overflow-hidden">
                        <img class="w-full h-full object-cover" data-alt="Admin user profile picture"
                            src="https://lh3.googleusercontent.com/aida-public/AB6AXuCTq97x_IMb8X0peJW82HLe-f0L-ujIGWMFSr7mlwRigArpcWZZf1Yp9TUobE7Z-3MwCmGU8DcXM9lM5iAirLiiVSeyQKmUtz6-HRYfHoYpjaqoOqH-k-WvJ3Js0hRz4HnxS7RqJholrvxPz9-CN2txcGpMzkQZ6JJdS7OYzxHw5VeHDDgiVuE4xohAqmTuhJ_TBTdtGQGd80e2g7rb8G1OTtAWmiLxjGg791_mYOQrw9qAwBSPVoLaw4aBrjYyl1PqeHuj7k_QEcU" />
                    </div>
                    ...
                    <span
                        class="material-symbols-outlined text-slate-400 cursor-pointer hover:text-primary">logout</span>
                </div>
            </div>
        </aside>
        <!-- Main Content Area -->
        <main class="ml-72 flex-1 flex flex-col min-h-screen">
                    ...
                    <div
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full text-left">
                                <thead>
                                    <tr
                                        class="bg-slate-50 0 border-b border-slate-200">
                                        <th
                                    ...
                                    <tr class="hover:bg-slate-50/80  transition-colors group">
                                        <td class="px-6 py-5">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <span class="font-semibold text-slate-900 dark:text-slate-100">Illegal
                                                    Parking</span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-5 text-slate-500  italic">
                                            Parking in unauthorized or restricted areas
                                        </td>
                                    ...
                                    <tr class="hover:bg-slate-50/80  transition-colors group">
                                        <td class="px-6 py-5">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <span
                                                    class="font-semibold text-slate-900">Overstay</span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-5 text-slate-500 dark:text-slate-400 italic">
                                            Vehicle stayed longer than reserved time slot
                                        </td>
                                        <td class="px-6 py-5 text-right space-x-2">
                                            <button
                                                class="p-2 text-primary hover:bg-primary/10 rounded-lg transition-colors">
                                    ...
                                    <tr class="hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition-colors group">
                                        <td class="px-6 py-5">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <span
                                                    class="font-semibold text-slate-900 dark:text-slate-100">Blocking</span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-5 text-slate-500 dark:text-slate-400 italic">
                                            Blocking other vehicles or designated parking lanes
                                        </td>
                                        <td class="px-6 py-5 text-right space-x-2">
                                            <button
                                                class="p-2 text-primary hover:bg-primary/10 rounded-lg transition-colors">
                        ...
                        <div
                            ...
                            <div class="flex gap-2">
                                <button
                                    class="px-3 py-1 border border-slate-200 dark:border-slate-700 rounded text-xs disabled:opacity-50"
                                    disabled="">Previous</button>
                                <button class="px-3 py-1 bg-primary text-white rounded text-xs">1</button>
                                <button
                                    class="px-3 py-1 border border-slate-200 dark:border-slate-700 rounded text-xs">Next</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Footer -->
            <footer
                class="mt-auto py-6 px-8 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 text-center">
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
        <div
            ...
            <div class="p-6 border-b border-slate-100  flex justify-between items-center">
                <h3 class="text-xl font-bold text-slate-900 ">Add New Violation Category</h3>
    ...
    <div>
        ...
        <input
            ...
            placeholder="e.g. Improper Loading"
            required
            class="w-full bg-slate-50 border-slate-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-slate-900">
    </div>
    ...
    <div>
        ...
        <textarea
            ...
            rows="4"
            required
            placeholder="Provide a brief description of this violation..."
            class="w-full bg-slate-50 border-slate-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-slate-900"><?php echo $description; ?></textarea>
    </div>
    ...
    <div class="flex items-center justify-end gap-3 pt-2">
        ...
        <button
            type="button"
            onclick="window.location.href='6.1_Violations_AdminPart.php'"
        ...
        <button
            type="submit"
            name="save"
            class="px-6 py-2.5 bg-accent-emerald hover:bg-emerald-600 text-white font-bold rounded-xl shadow-lg shadow-emerald-500/20 transition-all flex items-center gap-2">

            <span class="material-symbols-outlined text-sm">
                check
            </span>

            <?php echo ($id == "") ? "Add Category" : "Update Category"; ?>
